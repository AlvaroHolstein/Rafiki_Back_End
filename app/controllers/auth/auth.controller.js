...
let Auth = {
  ...
  register(req, res) {
    try {
      ...
      return res.status(400).send({ error: "Could not register User " + err });
    }
  },
  //login
  login(req, res) {
    try {
      ...
      return res.status(400).send({ error: "Could not login user " + err });
    }
  },
  //logout
  logout(req, res) {
    try {
      ...
      return res.status(400).send({ error: "Could not logout " + err });
    }
  },
  passwordreset(req, res) {
    try {
      ...
      return res.status(400).send({ error: "Could not send mail" + err });
    }
  },
  resetpassword(req, res) {
    try {
      ...
      return res.status(400).send({ error: "Could not reset password" + err });
    }
  },
  changepassword(req, res) {
    try {
      ...
      return res
        .status(400)
        .send({ error: "Could not change password " + err });
    }
  },
  keepLogged(req, res) {
    try {
      ...
      return res.status(400).send({ error: "Could not keep u logged" + err });
    }
  }
};
